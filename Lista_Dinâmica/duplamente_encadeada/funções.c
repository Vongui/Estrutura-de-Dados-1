...
void inserirInicio(Lista **lista, int x)
{
    ...
    {
        printf("Erro na alocacao do Lista.\n");
        return;
    }
}
...
Lista *pesquisar(Lista *lista, int x)
{
    Lista *procurar;
...
int removerValor(Lista **lista, int x)
{
    Lista *remover;
    int removido;
